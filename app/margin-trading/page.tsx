        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <AnimatedSection animation="fade-up">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-balance text-foreground">
              Margin <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Trading</span>
            </h1>
          </AnimatedSection>

          <AnimatedSection animation="fade-up" delay={200}>
            <p className="text-base md:text-xl text-muted-foreground mb-8 max-w-2xl leading-relaxed">
              Amplify your trading potential with leveraged trading. Trade stocks, ETFs, and commodities with borrowed capital and multiply your returns.
            </p>
          </AnimatedSection>
            ...
            {[
              {
                icon: TrendingUp,
                title: "High Leverage",
                description: "Trade with up to 50:1 leverage on major assets"
              },
              {
                icon: Zap,
                title: "Fast Execution",
                description: "Sub-millisecond order execution for optimal entry points"
              },
              {
                icon: Shield,
                title: "Risk Protection",
                description: "Automated stop-loss and margin call protections"
              },
              {
                icon: TrendingUp,
                title: "Wide Selection",
                description: "Trade stocks, commodities, indices, and more"
              }
            ].map((feature, idx) => {
        ...
        <div className="max-w-3xl mx-auto text-center">
          <AnimatedSection animation="fade-up">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
              Amplify Your Trading Gains
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              Experience the power of margin trading with professional tools and competitive rates.
            </p>
            <a href="https://app.vornexchain.com/register" target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="px-8 py-6 bg-gradient-to-r from-primary to-accent hover:opacity-90">
